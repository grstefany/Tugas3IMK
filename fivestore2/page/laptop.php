...
<div class="top-products">
	<div class="container">
    <h2 class="text-center text1">Kategori Laptop</h2>
		...
		<div class="row product" style="margin-top: 10px;">
			...
			$query = "SELECT * FROM produk WHERE kategori_produk='Laptop' ORDER by id_produk ASC LIMIT $num, $perpage";
			...
			$sql = mysqli_query($conn, "SELECT * FROM produk  WHERE kategori_produk = 'Laptop'  ORDER by id_produk ASC");
