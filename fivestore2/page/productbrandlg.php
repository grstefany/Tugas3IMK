...
<div class="top-products">
	<div class="container">
    <h2 class="text-center text1">Brand LG</h2>
		...
		<div class="row product" style="margin-top: 10px;">
			...
			$query = "SELECT * FROM produk WHERE brand_produk='LG' ORDER by id_produk ASC LIMIT $num, $perpage";
			...
			$sql = mysqli_query($conn, "SELECT * FROM produk  WHERE brand_produk = 'LG'  ORDER by id_produk ASC");
